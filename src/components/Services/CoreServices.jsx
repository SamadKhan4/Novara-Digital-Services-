...
function CoreServiceCard({ service }) {
  ...
  return (
    <GlassCard className="group flex h-full min-h-[220px] flex-col justify-between p-5 transition duration-300 hover:-translate-y-1 hover:border-cyan-300/55 hover:shadow-[0_0_36px_rgba(47,128,255,0.22)]">
      ...
      <div>
        <p className="text-xs leading-5 text-[#B9C2DA]">{service.text}</p>
        <a href={`/services/${service.slug}`} className="mt-5 inline-flex items-center gap-2 text-xs font-black text-[#8EA2FF]">
